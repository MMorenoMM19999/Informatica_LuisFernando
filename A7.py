...
# Este programa debe incluir dos bucles for: uno para calcular la suma y a continuación otro para escribir la última línea (con la suma de todos los números).
